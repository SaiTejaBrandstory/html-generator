...
export default function GeneratePage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const response = await fetch('/api/generate-pillar-page1', {
        method: 'POST',
        headers: {
      ...
      a.href = url
      a.download = `pillar-page-generated-${Date.now()}.zip`
      ...
      alert('Pillar page HTML file with assets generated and downloaded successfully!')
    } catch (err: any) {
