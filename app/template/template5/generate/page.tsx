...
export default function GeneratePage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const response = await fetch('/api/generate-template5', {
        method: 'POST',
        headers: {
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              placeholder="Enter your content here... (e.g., 'AngularJS development company in Bangalore', 'React development services', etc.)"
          ...
          <div className="flex gap-4">
            ...
            <button
              onClick={() => router.push('/template/template5')}
              disabled={isGenerating}
