...
export default function GenerateTemplate6() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const response = await fetch('/api/generate-template6', {
        method: 'POST',
        headers: {
      ...
      a.href = url
      a.download = `generated-template6-${Date.now()}.zip`
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              placeholder="Enter your content here... (e.g., 'Website development company in Bangalore', 'Digital marketing services', 'Web design agency', etc.)"
          ...
          <div className="flex gap-4">
            ...
            <button
              onClick={() => router.push('/template/template6')}
              disabled={isGenerating}
