...
export default function GenerateTemplate8() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const response = await fetch('/api/generate-template8', {
        method: 'POST',
        headers: {
      ...
      a.href = url
      a.download = `generated-template8-${Date.now()}.zip`
      ...
      alert('HTML file generated and downloaded successfully!')
    } catch (err: any) {
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <h1 className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                Template 8 Generator
              </h1>
            </div>
            <button
              onClick={() => router.push('/template/template8')}
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              placeholder="Enter your content here... (e.g., 'Landscape Contractors in Bangalore', 'Garden Design Services', etc.)"
