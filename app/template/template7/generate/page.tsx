...
export default function GenerateTemplate7() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const response = await fetch('/api/generate-template7', {
        method: 'POST',
        headers: {
      ...
      a.href = url
      a.download = `generated-template7-${Date.now()}.zip`
      ...
      <header className="bg-white dark:bg-gray-900 shadow-md border-b border-gray-200 dark:border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <button
              onClick={() => router.push('/template/template7')}
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              placeholder="Enter your content here... (e.g., 'Villa Interior Designers in Bangalore', 'Home Interior Design Services', etc.)"
