...
export default function GenerateTemplate4() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const response = await fetch('/api/generate-template4', {
        method: 'POST',
        headers: {
      ...
      a.href = url
      a.download = `generated-template4-${Date.now()}.zip`
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              placeholder="Enter your content here... (e.g., 'PR agency in Bangalore', 'Digital marketing services', 'Content marketing company', etc.)"
          ...
          <div className="flex gap-4">
            ...
            <button
              onClick={() => router.push('/template/template4')}
              disabled={isGenerating}
