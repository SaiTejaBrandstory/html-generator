...
export default function GeneratePage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const response = await fetch('/api/generate-pillar-page1-humanizer', {
        method: 'POST',
        headers: {
      ...
      a.href = url
      a.download = `pillar-page-generated-${Date.now()}-humanizer.zip`
      ...
      alert('Pillar page HTML file with humanized content and assets generated and downloaded successfully!')
    } catch (err: any) {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">
            Generate Pillar Page Content (Humanizer)
          </h2>
          ...
          <div className="mb-6">
            ...
            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
              This content will be used to generate all sections of the pillar page. Can be any topic - services, products, agencies, industries, etc. Be specific about the topic.
            </p>
          </div>
