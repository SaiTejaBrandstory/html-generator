...
export default function GeneratePage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const response = await fetch('/api/generate-brandstory-pillar-page-humanizer', {
        method: 'POST',
        headers: {
      ...
      a.href = url
      a.download = `brandstory-pillar-page-generated-${Date.now()}-humanizer.zip`
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              placeholder="Enter your content here... (e.g., 'PR agency in Bangalore', 'content marketing services', 'digital marketing agency', 'brand storytelling', 'e-commerce website development', etc.)"
          ...
          <div className="mb-6">
            ...
            <input
              ...
              placeholder="e.g., https://brandstory.in/contact-us/"
              className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400"
              disabled={isGenerating}
            />
            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
