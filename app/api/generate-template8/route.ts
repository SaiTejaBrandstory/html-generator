      ...
      try {
        ...
        completion = await openai.chat.completions.create({
          ...
          messages: [
            {
              role: 'system',
              content: 'You are a person. A real human being. You are an expert SEO content writer who writes exactly like a human would write - naturally, conversationally, with imperfections and personality. Achieve Flesch Kincaid\'s score between 60 to 70 and Surfer SEO score of 90 and above. Write as a real person, not as an AI. Always return valid JSON format with ALL sections filled based on the user input. Never use placeholder text or generic examples. The company name is "Relgrow" - always use "Relgrow" instead of any placeholders like "[Your Company Name]" or "[Company Name]".',
            },
            {
              role: 'user',
              content: prompt,
