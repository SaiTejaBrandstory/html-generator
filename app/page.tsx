          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100">
              <div className="relative overflow-hidden bg-gradient-to-br from-amber-50 to-orange-50">
                <div className="aspect-video w-full">
                  <img 
                    src="/assets/images/home-page/template9-banner.png" 
                    alt="Interior Design Services Template" 
                    className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                  />
                </div>
                <div className="absolute top-4 right-4">
              ...
              <div className="p-8">
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Landing Page Template 9</h3>
                <p className="text-gray-600 mb-6 leading-relaxed">
                  A comprehensive interior design landing page template with 16 content sections including hero banner, about section, project gallery with category filtering, expert reviews showcase, proven success statistics, comprehensive services overview, why choose us section, client testimonials, call-to-action section, contact forms with info items, and footer with company details. Perfect for interior design companies, architecture firms, and home renovation services with AI-powered content generation.
                </p>
                <div className="flex flex-col sm:flex-row gap-3">
                  <a 
                    href="/template/template9" 
                    className="flex-1 px-6 py-3 bg-gray-900 hover:bg-gray-800 text-white font-semibold rounded-lg transition-all duration-300 text-center shadow-md hover:shadow-lg hover:scale-[1.02]"
                  >
                    View Template
                  </a>
                  <a 
                    href="/template/template9/generate" 
                    className="flex-1 px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold rounded-lg transition-all duration-300 text-center shadow-md hover:shadow-lg hover:scale-[1.02]"
                  >
                    Generate
                  </a>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100">
              ...
              <div className="p-8">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <a 
                    href="/brandstory-pillar-page-humanizer" 
                    className="flex-1 px-6 py-3 bg-gray-900 hover:bg-gray-800 text-white font-semibold rounded-lg transition-all duration-300 text-center shadow-md hover:shadow-lg hover:scale-[1.02]"
                  >
                    View Template
                  </a>
                  <a 
                    href="/brandstory-pillar-page-humanizer/generate" 
                    className="flex-1 px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold rounded-lg transition-all duration-300 text-center shadow-md hover:shadow-lg hover:scale-[1.02]"
                  >
                    Generate
                  </a>
